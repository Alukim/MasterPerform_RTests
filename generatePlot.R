generatePlot <- function(path, money1, money2, money3, money4) {
  ...
  prediction3Machines = read.csv(prediction2PathMachines, header = TRUE, sep = ",")
  prediction4Machines = read.csv(prediction2PathMachines, header = TRUE, sep = ",")
  ...
  plot(prediction2Machines[,2], xlab = "Godzina w tygodniu", ylab = "Ilość maszyn", main = "Ilość maszyn na godzinę", type = "l", ylim = c(0, ylimMax))
  ...
  plot(prediction3Machines[,2], xlab = "Godzina w tygodniu", ylab = "Ilość maszyn", main = "Ilość maszyn na godzinę", type = "l", ylim = c(0, ylimMax))
  ...
  plot(prediction4Machines[,2], xlab = "Godzina w tygodniu", ylab = "Ilość maszyn", main = "Ilość maszyn na godzinę", type = "l", ylim = c(0, ylimMax))
